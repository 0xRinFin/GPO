...
LunarLight = {
    ...
    Maximise = Color3.fromRGB(189, 183, 177),
    MaximiseAccent = Color3.fromRGB(189, 183, 177),
    NavBar = Color3.fromRGB(232, 29, 68),
    NavBarAccent = Color3.fromRGB(30,30,30),
    NavBarInvert = Color3.fromRGB(30,30,30),
    TitleBar = Color3.fromRGB(232, 29, 68),
    TitleBarAccent = Color3.fromRGB(30,30,30),
    Overlay = Color3.fromRGB(30,30,30),
    Banner = Color3.fromRGB(30,30,30),
    BannerAccent = Color3.fromRGB(232, 29, 68),
    Content = Color3.fromRGB(136,29,50),
    Button = Color3.fromRGB(232, 29, 68),
    ButtonAccent = Color3.fromRGB(30,30,30),
    ChipSet = Color3.fromRGB(232, 29, 68),
    ChipSetAccent = Color3.fromRGB(30,30,30),
    DataTable = Color3.fromRGB(232, 29, 68),
    DataTableAccent = Color3.fromRGB(30,30,30),
    Slider = Color3.fromRGB(30,30,30),
    SliderAccent = Color3.fromRGB(232, 29, 68),
    Toggle = Color3.fromRGB(232, 29, 68),
    ToggleAccent = Color3.fromRGB(30,30,30),
    Dropdown = Color3.fromRGB(30,30,30),
    DropdownAccent = Color3.fromRGB(232, 29, 68),
    ColorPicker = Color3.fromRGB(30,30,30),
    ColorPickerAccent = Color3.fromRGB(232, 29, 68),
    TextField = Color3.fromRGB(175,175,175),
